...
import { publishContent } from '@/lib/content-store';

/**
 * POST /api/knowledge/publish
 * Accepts { content, title, price, payTo, description }
 * Stores content in the in-memory content store.
 * Returns { ok, contentId }
 */
