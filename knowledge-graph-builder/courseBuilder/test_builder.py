#!/usr/bin/env python3
"""Test script for Phase 4: Course Builder.
...
Usage (run from knowledge-graph-builder/):
  ...
  python courseBuilder/test_builder.py
  ...
  python courseBuilder/test_builder.py --skip-lessons

  # Custom model
  python courseBuilder/test_builder.py --model google/gemma-3-27b-it
"""
